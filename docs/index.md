...
features:
  - icon: 🧰
    title: 工具 / 管理
    details: 随机数 / UUID 生成、消息删除、按条件批量清理消息、频道移动、文本转文件、指令同步
    link: /modules/tools
  - icon: 😄
    title: 表情
  ...
  - icon: 🔑
    title: 三层权限系统
    details: 服务器管理员 / 配置管理员 / Mod 三层自定义权限，声明式装饰器统一控制
